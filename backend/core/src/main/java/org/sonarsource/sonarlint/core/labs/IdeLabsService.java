...
public class IdeLabsService {
  private static final String IDE_LABS_SUBSCRIPTION_URL = "https://discover.sonarsource.com/sq-ide-labs.json";
  ...
  public JoinIdeLabsProgramResponse joinIdeLabsProgram(String email, String ideName) {
    ...
    try (var response = httpClient.post(IDE_LABS_SUBSCRIPTION_URL, "application/json", requestBody)) {
